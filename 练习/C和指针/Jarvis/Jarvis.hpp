...
private:
    ...
    std::string api_key="8b73b692840d4537b8b2f01b025c6b83";
...
class SpeechRec{
private:
	std::string app_id="18281675"; 
	std::string api_key="sP00BhC7jHZC7rEOpadAj4Y4";
    std::string secret_key="bGNzQSjPQ1GpKlhQLqznhaz2zYbtDXWf";
